...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI3_MspInit 0 */
    ...
    PB5     ------> SPI3_MOSI 
    */
    GPIO_InitStruct.Pin = BARO_SPI_SCK_Pin|BARO_SPI_MISO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    ...
    GPIO_InitStruct.Pin = BARO_SPI_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF6_SPI3;
    HAL_GPIO_Init(BARO_SPI_MOSI_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PB5     ------> SPI3_MOSI 
    */
    HAL_GPIO_DeInit(GPIOC, BARO_SPI_SCK_Pin|BARO_SPI_MISO_Pin);

    HAL_GPIO_DeInit(BARO_SPI_MOSI_GPIO_Port, BARO_SPI_MOSI_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX 
    */
    HAL_GPIO_DeInit(GPIOA, RADIO_UART_TX_Pin|RADIO_UART_RX_Pin);
